...
using SpiritcallerRoninMod.Content.Bosses.Akane;
...
namespace SpiritcallerRoninMod.Content.Items.Consumables
{
	...
	public class AkaneBag : ModItem
	{
		...
		public override void ModifyItemLoot(ItemLoot itemLoot) {
			...
			itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<PikeOfTheWarden>(), 1));
			itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<WardensHalo>(), 2));
			...
			itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(ModContent.NPCType<AkaneTheWardenOfTheEnd>()));
		}
	}
}