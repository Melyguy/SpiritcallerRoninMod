...
namespace SpiritcallerRoninMod.Content.Items.Armor
{
	...
	public class HellstoneRoninHelmet : ModItem
	{
		...
		public override bool IsArmorSet(Item head, Item body, Item legs) {
			return body.type == ModContent.ItemType<HellstoneRoninChestplate>() && legs.type == ModContent.ItemType<HellstoneRoninLeggings>();
		}
