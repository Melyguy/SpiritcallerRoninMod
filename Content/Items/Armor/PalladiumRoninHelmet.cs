...
namespace SpiritcallerRoninMod.Content.Items.Armor
{
	...
	public class PalladiumRoninHelmet : ModItem
	{
		...
		public override bool IsArmorSet(Item head, Item body, Item legs) {
			return body.type == ModContent.ItemType<PalladiumRoninChestplate>() && legs.type == ModContent.ItemType<PalladiumRoninLeggings>();
		}
