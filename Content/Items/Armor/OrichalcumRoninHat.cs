...
namespace SpiritcallerRoninMod.Content.Items.Armor
{
	...
	public class OrichalcumRoninHat : ModItem
	{
		...
		public override bool IsArmorSet(Item head, Item body, Item legs) {
			return body.type == ModContent.ItemType<OrichalcumRoninChestplate>() && legs.type == ModContent.ItemType<OrichalcumRoninLeggings>();
		}
