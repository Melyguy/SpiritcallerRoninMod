...
namespace SpiritcallerRoninMod.Content.Items.Armor
{
	...
	public class HallowedRoninHelmet : ModItem
	{
		...
		public override bool IsArmorSet(Item head, Item body, Item legs) {
			return body.type == ModContent.ItemType<HallowedRoninChestplate>() && legs.type == ModContent.ItemType<HallowedRoninLeggings>();
		}
