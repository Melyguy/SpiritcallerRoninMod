...
namespace SpiritcallerRoninMod.Content.Items.Weapons
{
	public class OnryoScream : ModItem
	{
		...
		{
			return new Vector2(0, 0); // Adjusted X to hold more towards the blade
		}
