...
namespace SpiritcallerRoninMod.Content.Items.Weapons
{
	...
	/// </summary>
	public class FrozenKatana : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.damage = 80; // Higher base damage against evil
		...
		public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback) {
			...
			switch (slashCounter) {
				case 0: // Corruption's Strength
					projectileType = ModContent.ProjectileType<ImbuedKatanaSlash2>();
					extraProjectileType = ProjectileID.IceSickle;
					break;
				default: // Crimson's Power
					projectileType = ModContent.ProjectileType<ImbuedKatanaSlash>();
					extraProjectileType = ProjectileID.IceSickle;
					break;
			}
