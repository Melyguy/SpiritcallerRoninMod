...
namespace SpiritcallerRoninMod.Content.Items.Weapons
{
	public class WardensHalo : ModItem
	{
		public override void SetDefaults() {
			...
			Item.scale = 1f; // Adjust this value between 0.1 and 1.0 to get the desired size
