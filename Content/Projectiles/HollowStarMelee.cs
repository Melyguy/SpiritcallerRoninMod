...
namespace SpiritcallerRoninMod.Content.Projectiles
{
	...
	public class HollowStarMelee : ModProjectile
	{
		...
		public override void AI() {
			...
			if (Main.rand.NextFloat() * 2f < Projectile.Opacity) {
			    ...
			    Dust coloredDust = Dust.NewDustPerfect(
			        ...
			        DustID.Shadowflame, // or DustID.PurpleTorch
			        dustVelocity * 1f, 100, dustColor, 0.4f);
			    coloredDust.fadeIn = 0.4f + Main.rand.NextFloat() * 0.15f;
			    coloredDust.noGravity = true;
			}

			if (Main.rand.NextFloat() * 1.5f < Projectile.Opacity) {
			    Dust.NewDustPerfect(dustPosition, DustID.Shadowflame, dustVelocity, 100, Color.Purple * Projectile.Opacity, 1.2f * Projectile.Opacity);
			}
...
Color backDarkColor = new Color(40, 0, 60);        // Deep cosmic purple
Color middleMediumColor = new Color(120, 30, 150); // Vivid violet
Color frontLightColor = new Color(200, 160, 255);  // Soft lavender glow
