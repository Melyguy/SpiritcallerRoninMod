...
namespace SpiritcallerRoninMod.Content.Projectiles
{
	...
	public class VirtueSlash2 : ModProjectile
	{
		...
		public override void AI() {
			...
			if (Main.rand.NextFloat() * 2f < Projectile.Opacity) {
				// Original Excalibur color: Color.Gold, Color.Yellow
				Color dustColor = Color.Lerp(Color.Pink, Color.Yellow, Main.rand.NextFloat() * 0.3f);
			...
			if (Main.rand.NextFloat() * 1.5f < Projectile.Opacity) {
				// Original Excalibur color: Color.Yellow
		...
		public override bool PreDraw(ref Color lightColor) {
			...
			Main.EntitySpriteDraw(texture, position, texture.Frame(1, 4, 0, 3), Color.Yellow * 0.6f * lerpTime, Projectile.rotation + Projectile.ai[0] * 0.01f, origin, scale, spriteEffects, 0f);
			// Thin middle line (final frame)
			Main.EntitySpriteDraw(texture, position, texture.Frame(1, 4, 0, 3), Color.Yellow * 0.5f * lerpTime, Projectile.rotation + Projectile.ai[0] * -0.05f, origin, scale * 0.8f, spriteEffects, 0f);
			// Thin bottom line (final frame)
			Main.EntitySpriteDraw(texture, position, texture.Frame(1, 4, 0, 3), Color.Yellow * 0.4f * lerpTime, Projectile.rotation + Projectile.ai[0] * -0.1f, origin, scale * 0.6f, spriteEffects, 0f);
