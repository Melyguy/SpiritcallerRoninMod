...
{
    public class HollowStarSlashBoss : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextBool(2))
            {
                ...
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 
                    DustID.PurpleTorch, Projectile.velocity.X * 0.2f, 
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color drawColor = Color.Lerp(Color.Purple, Color.Purple, 0.3f) * Projectile.Opacity;
