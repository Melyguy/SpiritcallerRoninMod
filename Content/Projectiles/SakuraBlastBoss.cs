...
{
    public class SakuraBlastBoss : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>("SpiritcallerRoninMod/Content/Projectiles/SakuraBlastBoss").Value;
