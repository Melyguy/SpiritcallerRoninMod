...
namespace SpiritcallerRoninMod.Content.Projectiles
{
	...
	public class HollowStarMelee2 : ModProjectile
	{
		...
		public override void AI() {
			...
			if (Main.rand.NextFloat() * 2f < Projectile.Opacity) {
				...
				Color dustColor = Color.Lerp(Color.Pink, Color.Purple, Main.rand.NextFloat() * 0.3f);
    ...
    Color frontLightColor = new Color(255, 230, 100);   // Hot flame yellow
			...
			Color PurpleTimesLerpTime = Color.Purple * lerpTime * 0.5f;
			PurpleTimesLerpTime.A = (byte)(PurpleTimesLerpTime.A * (1f - lightingColor));
			Color faintLightingColor = PurpleTimesLerpTime * lightingColor * 0.5f;
			...
			// Main.EntitySpriteDraw(TextureAssets.MagicPixel.Value, position, sourceRectangle, Color.Purple * 0.75f, 0f, origin, scale, spriteEffects);
