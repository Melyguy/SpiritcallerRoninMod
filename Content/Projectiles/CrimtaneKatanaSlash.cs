...
namespace SpiritcallerRoninMod.Content.Projectiles
{
	...
	public class CrimtaneKatanaSlash : ModProjectile
	{
		...
		public override void AI() {
			...
			if (Main.rand.NextFloat() * 2f < Projectile.Opacity) {
				// Original Excalibur color: Color.Gold, Color.Pink
			...
			if (Main.rand.NextFloat() * 1.5f < Projectile.Opacity) {
				// Original Excalibur color: Color.Pink
		...
		public override bool PreDraw(ref Color lightColor) {
			...
			Color PinkTimesLerpTime = Color.Pink * lerpTime * 0.5f;
