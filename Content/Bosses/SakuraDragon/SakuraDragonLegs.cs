...
{
    public class SakuraDragonLegs : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            float desiredSpacing = NPC.width * 0.8f; // Slightly closer than full width to avoid gaps
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            Vector2 origin = new Vector2(texture.Width / 3f, texture.Height / 2f);
            float scale = 1f;
